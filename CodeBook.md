...
Of interest to us is the set of variables that were estimated from these signals which are mean and standard deviation of the measurements (not the max, the min, the mad - median absolute deviation, etc).

mean(): Mean value
std(): Standard deviation

Please see the README.md file for the procedure and explicit list of variables in the final dataset.
